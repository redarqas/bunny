...
lazy val sharedSettings = Seq(
  projectTitle := "Bunny Library",
  projectWebsiteRootURL := "https://redarqas.github.io/",
  projectWebsiteBasePath := "/bunny-library/",
  githubOwnerID := "redarqas",
  githubRelativeRepositoryID := "bunny-library",

  organization := "org.redarqas",
  scalaVersion := "2.13.1",
  ...
  developers := List(
    Developer(
      id="redarqas",
      name="Jamal CHAQOURI",
      email="jamal.chaqouri@gmail.com",
      url=url("https://redarqas.org")
    )),
...
lazy val site = project.in(file("site"))
  ...
  .settings {
    ...
    Seq(
      ...
      micrositeAuthor := "Jamal CHAQOURI",
      micrositeTwitterCreator := "@redarqas",
